            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature_post_text">
                        <img src="{{asset('user/img/feature_1.png')}}" alt="#">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature_post_text">
                        <img src="{{asset('user/img/feature_2.png')}}" alt="#">
                        <div class="hover_text">
                            <a href="single-product.html" class="btn_2">shop for male</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature_post_text">
                        <img src="{{asset('user/img/feature_3.png')}}" alt="#">
                        <div class="hover_text">
                            <a href="single-product.html" class="btn_2">shop for male</a>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="single_arrivel_item weidth_3 mix women men ml-3">
                            <img src="{{asset('user/img/arrivel/arrivel_3.png')}}" alt="#">
                            <div class="hover_text">
                                <p>Canvas</p>
                        ...
                        <div class="single_arrivel_item weidth_1 mix shoes men mr-2">
                        ...
                        <div class="single_arrivel_item weidth_3 mix women men ml-4">
                            <img src="{{asset('user/img/arrivel/arrivel_4.png')}}" alt="#">
                            <div class="hover_text">
                                <p>Canvas</p>
                                <a href="single-product.html"><h3>Lorem Canvas Low-Top Sneaker</h3></a>
                                <div class="rate_icon">
                        ...
                        <div class="single_arrivel_item weidth_2 mix men women">
                            <img src="{{asset('user/img/arrivel/arrivel_1.png')}}" alt="#">
                            <div class="hover_text">
                                <p>Canvas</p>
                                <a href="single-product.html"><h3>Lorem Canvas Low-Top Sneaker</h3></a>
                                <div class="rate_icon">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_shopping_details">
                        <img src="{{asset('user/img/icon/icon_1.png')}}" alt="">
                        <h4>Free shipping</h4>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_shopping_details">
                        <img src="{{asset('user/img/icon/icon_2.png')}}" alt="">
                        <h4>Free shipping</h4>
                        <p>Divided face for bearing the divide unto seed winged divided light Forth.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_shopping_details">
                        <img src="{{asset('user/img/icon/icon_3.png')}}" alt="">
                        <h4>Free shipping</h4>
                        <p>Divided face for bearing the divide unto seed winged divided light Forth.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="single_shopping_details">
                        <img src="{{asset('user/img/icon/icon_4.png')}}" alt="">
                        <h4>Free shipping</h4>
                        <p>Divided face for bearing the divide unto seed winged divided light Forth.</p>
                    </div>
                </div>
