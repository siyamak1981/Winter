                    ...
                    <div class="blog_left_sidebar">
                     ...
                     <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="{{Storage::disk('local')->url($post->image)}}" alt="">
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="{{$post->slug}}">
                                    <h2>{{$post->subtitle}}</h2>
                                </a>
                                <p>{{$post->body}}</p>
                                <ul class="blog-info-link">
                                    ...
                                    <li><a href="#"><i class="far fa-calendar"></i>{{$post->create_at}}</a></li>
                                    
                                    <li><small> 0 </small><a href="#"><i class="far fa-thumbs-up"></i></a></li>
                                </ul>
                            </div>
                        </article>
                     @endforeach
